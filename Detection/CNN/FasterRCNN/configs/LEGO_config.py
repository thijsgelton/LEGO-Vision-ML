...
# data set config
__C.DATA.DATASET = "LEGO"
__C.DATA.MAP_FILE_PATH = "D:\LEGO Vision Datasets\detection-synthetic-data"
...
__C.DATA.NUM_TRAIN_IMAGES = 62
__C.DATA.NUM_TEST_IMAGES = 20
__C.DATA.PROPOSAL_LAYER_SCALES = [4, 6, 8]
