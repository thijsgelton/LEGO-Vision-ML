...
__C.DATA = edict()
cfg = __C
base_directory = r"D:\LEGO Vision Datasets\Detection\Faster R-CNN\Synthetic Data"
# data set config
__C.DATA.DATASET = "LEGO Detection Synthetic"
...
__C.DATA.NUM_TRAIN_IMAGES = len(open(os.path.join(base_directory, "train_img_file.txt")).readlines())
__C.DATA.NUM_TEST_IMAGES = len(open(os.path.join(base_directory, "test_img_file.txt")).readlines())
__C.DATA.PROPOSAL_LAYER_SCALES = [6, 10, 14]
